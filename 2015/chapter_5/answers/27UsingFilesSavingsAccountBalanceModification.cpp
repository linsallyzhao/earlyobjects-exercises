...
int main()
{
    ...
    outfile.open("Savings Account Balance");
    outfile << "Summary for three month\n";
    outfile << "_________________________________\n";
    outfile << std::left << std::setw(20) << "Start balance:" << "$"
              << std::right << std::setw(8) << std::fixed << std::setprecision(2)
              << startBalance << std::endl;
    outfile << std::left << std::setw(20) << "Total Deposit:" << "$"
              << std::right << std::setw(8) << std::fixed << std::setprecision(2)
              << totalDeposit << std::endl;
    outfile << std::left << std::setw(20) << "Total Withdrawal:" << "$"
              << std::right << std::setw(8) << std::fixed << std::setprecision(2)
              << totalWithdrawal << std::endl;
    outfile << std::left << std::setw(20) << "Total Interest:" << "$"
              << std::right << std::setw(8) << std::fixed << std::setprecision(2)
              << totalInterest << std::endl;
    outfile << std::left << std::setw(20) << "Final Balance:" << "$"
              << std::right << std::setw(8) << std::fixed << std::setprecision(2)
              << balance << std::endl;
    return 0;
}
